        ...
        this.patterns = {
            ...
            過度な叱責: {
                keywords: [
                    ...
                    'あなたは理解力がない', 'あいつは理解力がない', '本当に理解力がない',
                    'あなたに判断力がない', 'そんな判断力もない', '思考能力が欠けている',
                    // 学習・成長への否定
            ...
            // 軽微な否定パターンは誤検知が多いため一時無効化
            // 軽微な否定: {
            //     keywords: ['完全に問題がある', '明らかにダメ'],
            //     weight: 3,
            //     color: 'yellow'
            // },
            // 職場での不適切な表現パターンは誤検知が多いため一時無効化
            // 職場での不適切な表現: {
            //     keywords: ['そんなことも知らないの', 'あなたのような人は'],
            //     weight: 2,
            //     color: 'orange'
            // },
            敬語での威圧: {
            ...
            部分一致強化: {
                keywords: [
                    // 価値否定系（具体的な表現のみ）
                    '価値がない', '価値はない', '無価値', '存在価値がない',
                    // 行動・態度否定（具体的な表現のみ）
                    '仕事辞め', '給料泥棒', '邪魔な存在',
                    // 能力・知能（攻撃的文脈のみ）
                    'あなたはやる気がない', 'お前は理解力が', 'あいつに判断力',
                    // 威圧的な表現（具体的な威圧文脈のみ）

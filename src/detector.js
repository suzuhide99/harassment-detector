        ...
        this.patterns = {
            人格否定: {
                keywords: [
                    ...
                    // 価値否定系を強化
                    '価値はない', '価値がない', '無価値', '無価値な人間', '無価値な存在',
                    'あなたに価値はない', 'あなたは無価値', '存在価値がない', '生きる価値がない',
                    '価値のない人間', '無意味な人間', '無意味な存在', 'いてもいなくても同じ',
                    '必要のない人間', '不要な存在', '邪魔な存在'
                ],
                weight: 15,
                color: 'red'
            ...
            // 部分一致強化パターンは一時的に無効化（音声認識問題解決のため）
            // 部分一致強化: {
            //     keywords: ['仕事', '辞め', 'やめ', '帰っ', '邪魔', '顔'],
            //     weight: 1,
            //     color: 'yellow'
            // }
        };
